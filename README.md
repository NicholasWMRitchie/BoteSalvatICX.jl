...
```julia
ionizationcrosssection(BoteSalvat2009, z::Int, subshell::Int, energy::AbstractFloat, edgeenergy::AbstractFloat=edgeenergy(BoteSalvat2009, z, subshell))
```
...
```julia
hasedge(BoteSalvat2009, z::Integer, subshell::Int)
```
* True if data is available to compute the cross section for the specified sub-shell

```julia
edgeenergy(BoteSalvat2009, z::Integer, subshell::Int)
```
